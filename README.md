...
| **策略研究** | SMA 双均线、版本化回测、参数网格搜索、严格样本外 Walk-forward 优化、固定参数滚动窗口诊断、交易序列 Monte Carlo 风险分布、Bootstrap 交易样本稳健性测试、固定参数样本内/样本外分析、SMA 局部参数敏感性分析、策略提升治理、市场数据导入与版本化实验记录 |
