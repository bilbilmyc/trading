...
class Order(BaseModel):
    ...
    stop_price: Optional[float] = Field(None, gt=0, description="止损触发价")
    
    # 订单标识
    order_id: Optional[str] = Field(None, description="交易所订单 ID")
    ...
    avg_fill_price: Optional[float] = Field(None, ge=0, description="平均成交价")
