...
class Ticker(BaseModel):
    ...
    bid_price: Optional[float] = Field(None, ge=0, description="买一价")
    ask_price: Optional[float] = Field(None, ge=0, description="卖一价")
    high_24h: Optional[float] = Field(None, ge=0, description="24 小时最高价")
    low_24h: Optional[float] = Field(None, ge=0, description="24 小时最低价")
    volume_24h: Optional[float] = Field(None, ge=0, description="24 小时成交量")
    quote_volume_24h: Optional[float] = Field(None, ge=0, description="24 小时成交额")
    price_change_24h: Optional[float] = Field(None, description="24 小时涨跌额")
    price_change_pct_24h: Optional[float] = Field(None, description="24 小时涨跌幅")
