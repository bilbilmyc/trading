...
export function StrategiesPage() {
  ...
  return (
    <div className="page page--strategies stack">
      ...
      {/* Row 1 — six AutoClip summary tiles (col-span 2 each = 12). */}
      ...
      {/* Row 2 — AI report (8 cols) + sticky SMA create form (4 cols). */}
      <div className="page__grid--12">
        <div className="col-span-8">
          <Card title="AI 分析" subtitle="大模型一次性市场分析（不自动下单）" density="compact">
        ...
        <div className="col-span-4 sticky-top">
          <Card title="新建 SMA 策略" subtitle="简单移动平均交叉" density="compact">
      ...
      {/* Row 3 — strategies (7 cols) + signals (5 cols). */}
      <div className="page__grid--12">
          ...
          >
            {signals.length === 0 ? (
              <EmptyState
                variant="iconic"
                title="暂无信号"
                hint="启动 Runner 后会自动记录"
                action={{ label: "去风控启动", href: "/risk" }}
              />
            ) : (
              <>
